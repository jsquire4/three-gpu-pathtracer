...
`;
	...
	const spectral_accumulator = /* glsl */`
...
`;
		...
		constructor( parameters ) {
			...
			super( {
				...
				uniforms: {
					...
					u_scatterAlbedo: { value: new three.Vector3( 0.8, 0.85, 0.9 ) },
					...
					u_sssAlbedo: { value: new three.Vector3( 0.9, 0.9, 0.9 ) },
					...
					u_jakobCoeffs: { value: new three.Vector3( 0.0, 0.0, 0.0 ) },
	...
	function* renderTask() {
		...
		while ( true ) {
			...
			if ( this.additiveAccumulation ) {
				...
				material.blendEquationRGB = three.AddEquation;
				material.blendEquationAlpha = three.AddEquation;
				material.blendSrcRGB = three.OneFactor;
	...
	class AmbientOcclusionMaterial extends MaterialBase {
		...
		set normalMapType( v ) {
			...
			if ( v !== three.TangentSpaceNormalMap ) {
	...
	exports.AmbientOcclusionMaterial = AmbientOcclusionMaterial;
